...
namespace detail {
    ...
    template<> struct metadata<unit_design_t>
    {
        ...
        static constexpr metadatum<unit_design_t, int> crew()
        {
            using namespace std::literals;
            return {"crew"sv, 16, &unit_design_t::crew};
        }
        static constexpr metadatum<unit_design_t, int> propulsion_space()
        {
            using namespace std::literals;
            return {"propulsion_space"sv, 17, &unit_design_t::propulsion_space};
        }
        static constexpr metadatum<unit_design_t, int> weapons_space()
        {
            using namespace std::literals;
            return {"weapons_space"sv, 18, &unit_design_t::weapons_space};
        }
        static constexpr metadatum<unit_design_t, int> shields_space()
        {
            using namespace std::literals;
            return {"shields_space"sv, 19, &unit_design_t::shields_space};
        }
        static constexpr metadatum<unit_design_t, int> detection_space()
        {
            using namespace std::literals;
            return {"detection_space"sv, 20, &unit_design_t::detection_space};
        }
        static constexpr metadatum<unit_design_t, int> stealth_space()
        {
            using namespace std::literals;
            return {"stealth_space"sv, 21, &unit_design_t::stealth_space};
        }
        static constexpr metadatum<unit_design_t, float> effective_propulsion()
        {
            using namespace std::literals;
            return {"effective_propulsion"sv, 22, &unit_design_t::effective_propulsion};
        }
        static constexpr metadatum<unit_design_t, float> effective_weapons()
        {
            using namespace std::literals;
            return {"effective_weapons"sv, 23, &unit_design_t::effective_weapons};
        }
        static constexpr metadatum<unit_design_t, float> effective_shields()
        {
            using namespace std::literals;
            return {"effective_shields"sv, 24, &unit_design_t::effective_shields};
        }
        static constexpr metadatum<unit_design_t, float> effective_detection()
        {
            using namespace std::literals;
            return {"effective_detection"sv, 25, &unit_design_t::effective_detection};
        }
        static constexpr metadatum<unit_design_t, float> effective_stealth()
        {
            using namespace std::literals;
            return {"effective_stealth"sv, 26, &unit_design_t::effective_stealth};
        }
        static constexpr metadatum<unit_design_t, int> propulsion_reliability()
        {
            using namespace std::literals;
            return {"propulsion_reliability"sv, 27, &unit_design_t::propulsion_reliability};
        }
        static constexpr metadatum<unit_design_t, int> weapons_reliability()
        {
            using namespace std::literals;
            return {"weapons_reliability"sv, 28, &unit_design_t::weapons_reliability};
        }
        static constexpr metadatum<unit_design_t, int> shields_reliability()
        {
            using namespace std::literals;
            return {"shields_reliability"sv, 29, &unit_design_t::shields_reliability};
        }
        static constexpr metadatum<unit_design_t, int> detection_reliability()
        {
            using namespace std::literals;
            return {"detection_reliability"sv, 30, &unit_design_t::detection_reliability};
        }
        static constexpr metadatum<unit_design_t, int> stealth_reliability()
        {
            using namespace std::literals;
            return {"stealth_reliability"sv, 31, &unit_design_t::stealth_reliability};
        }
        static constexpr metadatum<unit_design_t, int> known_propulsion_failures()
        {
            using namespace std::literals;
            return {"known_propulsion_failures"sv, 32, &unit_design_t::known_propulsion_failures};
        }
        static constexpr metadatum<unit_design_t, int> known_weapons_failures()
        {
            using namespace std::literals;
            return {"known_weapons_failures"sv, 33, &unit_design_t::known_weapons_failures};
        }
        static constexpr metadatum<unit_design_t, int> known_shields_failures()
        {
            using namespace std::literals;
            return {"known_shields_failures"sv, 34, &unit_design_t::known_shields_failures};
        }
        static constexpr metadatum<unit_design_t, int> known_detection_failures()
        {
            using namespace std::literals;
            return {"known_detection_failures"sv, 35, &unit_design_t::known_detection_failures};
        }
        static constexpr metadatum<unit_design_t, int> known_stealth_failures()
        {
            using namespace std::literals;
            return {"known_stealth_failures"sv, 36, &unit_design_t::known_stealth_failures};
        }
        static constexpr metadatum<unit_design_t, float> design_months_remaining()
        {
            using namespace std::literals;
            return {"design_months_remaining"sv, 37, &unit_design_t::design_months_remaining};
        }
    ...
    template<> struct metadata<resource_t>
    {
        ...
        static constexpr metadatum<resource_t, int> available()
        {
            using namespace std::literals;
            return {"available"sv, 1, &resource_t::available};
        }
    ...
    template<> struct metadata<settlement_t>
    {
        ...
        static constexpr int lo_field_number() { return 1; }
        static constexpr int hi_field_number() { return 31; }
        ...
        static constexpr metadatum<settlement_t, resource_t> fuel()
        {
            using namespace std::literals;
            return {"fuel"sv, 11, &settlement_t::fuel};
        }
        static constexpr metadatum<settlement_t, resource_t> supplies()
        {
            using namespace std::literals;
            return {"supplies"sv, 12, &settlement_t::supplies};
        }
        static constexpr metadatum<settlement_t, resource_t> crewpower()
        {
            using namespace std::literals;
            return {"crewpower"sv, 13, &settlement_t::crewpower};
        }
        static constexpr metadatum<settlement_t, resource_t> rounds()
        {
            using namespace std::literals;
            return {"rounds"sv, 14, &settlement_t::rounds};
        }
        static constexpr metadatum<settlement_t, resource_t> missiles()
        {
            using namespace std::literals;
            return {"missiles"sv, 15, &settlement_t::missiles};
        }
        static constexpr metadatum<settlement_t, resource_t> fighters()
        {
            using namespace std::literals;
            return {"fighters"sv, 16, &settlement_t::fighters};
        }
        static constexpr metadatum<settlement_t, int> shipyard_pops()
        {
            using namespace std::literals;
            return {"shipyard_pops"sv, 17, &settlement_t::shipyard_pops};
        }
        static constexpr metadatum<settlement_t, int> infrastructure_upgrade_pops()
        {
            using namespace std::literals;
            return {"infrastructure_upgrade_pops"sv, 18, &settlement_t::infrastructure_upgrade_pops};
        }
        static constexpr metadatum<settlement_t, int> infrastructure_maintenance_pops()
        {
            using namespace std::literals;
            return {"infrastructure_maintenance_pops"sv, 19, &settlement_t::infrastructure_maintenance_pops};
        }
        static constexpr metadatum<settlement_t, int> infrastructure_repair_pops()
        {
            using namespace std::literals;
            return {"infrastructure_repair_pops"sv, 20, &settlement_t::infrastructure_repair_pops};
        }
        static constexpr metadatum<settlement_t, int> water_pops()
        {
            using namespace std::literals;
            return {"water_pops"sv, 21, &settlement_t::water_pops};
        }
        static constexpr metadatum<settlement_t, int> food_pops()
        {
            using namespace std::literals;
            return {"food_pops"sv, 22, &settlement_t::food_pops};
        }
        static constexpr metadatum<settlement_t, int> energy_pops()
        {
            using namespace std::literals;
            return {"energy_pops"sv, 23, &settlement_t::energy_pops};
        }
        static constexpr metadatum<settlement_t, int> metal_pops()
        {
            using namespace std::literals;
            return {"metal_pops"sv, 24, &settlement_t::metal_pops};
        }
        static constexpr metadatum<settlement_t, int> fuel_minerals_pops()
        {
            using namespace std::literals;
            return {"fuel_minerals_pops"sv, 25, &settlement_t::fuel_minerals_pops};
        }
        static constexpr metadatum<settlement_t, int> fuel_refining_pops()
        {
            using namespace std::literals;
            return {"fuel_refining_pops"sv, 26, &settlement_t::fuel_refining_pops};
        }
        static constexpr metadatum<settlement_t, int> supply_manufaturing_pops()
        {
            using namespace std::literals;
            return {"supply_manufaturing_pops"sv, 27, &settlement_t::supply_manufaturing_pops};
        }
        static constexpr metadatum<settlement_t, int> round_manufaturing_pops()
        {
            using namespace std::literals;
            return {"round_manufaturing_pops"sv, 28, &settlement_t::round_manufaturing_pops};
        }
        static constexpr metadatum<settlement_t, int> missile_manufaturing_pops()
        {
            using namespace std::literals;
            return {"missile_manufaturing_pops"sv, 29, &settlement_t::missile_manufaturing_pops};
        }
        static constexpr metadatum<settlement_t, int> fighter_manufaturing_pops()
        {
            using namespace std::literals;
            return {"fighter_manufaturing_pops"sv, 30, &settlement_t::fighter_manufaturing_pops};
        }
        static constexpr metadatum<settlement_t, std::vector<nation_and_object_id_t>> garrison()
        {
            using namespace std::literals;
            return {"garrison"sv, 31, &settlement_t::garrison};
        }
