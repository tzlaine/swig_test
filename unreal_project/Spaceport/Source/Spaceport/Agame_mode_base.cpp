...
void Agame_mode_base::Tick(float secs)
{
    Super::Tick(secs);
...
void Agame_mode_base::ready_for_game()
{
    UE_LOG(LogTemp, Log, TEXT("ENTER Agame_mode_base::ready_for_game()"));
    if (Ugame_instance::get()->game_kind() == game_kind::sp)
        ready_for_sp_game();
    else
        ready_for_mp_game();
    UE_LOG(LogTemp, Log, TEXT("EXIT Agame_mode_base::ready_for_game()"));
...
void Agame_mode_base::load_or_generate_Implementation(
...
void Agame_mode_base::multicast_quit_to_menu_Implementation()
{
...
void Agame_mode_base::ready_for_sp_game()
{
...
void Agame_mode_base::ready_for_mp_game()
{
    // TODO
}

void Agame_mode_base::signal_start_of_play()
{
