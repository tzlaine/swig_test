...
-- Given a planet that was randomly generated, determine its permanent effects
-- from things like gravity, atmosphere suitability, etc.  Return the
-- population growth factor computed from the base factor and all the applied
-- effects
