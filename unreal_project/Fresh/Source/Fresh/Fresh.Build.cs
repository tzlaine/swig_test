...
public class Fresh : ModuleRules
{
	...
	public Fresh(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        PublicIncludePaths.Add(Path.Combine(ModulePath, "../../../../unreal_project/Fresh/Source/Fresh"));
